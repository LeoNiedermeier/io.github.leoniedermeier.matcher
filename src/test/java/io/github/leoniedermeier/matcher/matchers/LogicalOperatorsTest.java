...
import static io.github.leoniedermeier.matcher.matchers.LogicalOperators.*;
...
class LogicalOperatorsTest {
    ...
    class Or {
        ...
        void matches_first() {
            TestMatcher testMatcher_1 = new TestMatcher(true);
            TestMatcher testMatcher_2 = new TestMatcher(false);
            assertMatcherTrue("123", or(testMatcher_1, testMatcher_2));
            assertTestMatcher(testMatcher_1, 1, "123");
            assertTestMatcher(testMatcher_2, 0, null);
        }
        ...
        void not_matches() {
            TestMatcher testMatcher_1 = new TestMatcher(false);
            TestMatcher testMatcher_2 = new TestMatcher(false);
            assertMatcherFalse("123", or(testMatcher_1, testMatcher_2));
            assertTestMatcher(testMatcher_1, 1, "123");
            assertTestMatcher(testMatcher_2, 1, "123");
        }
    }
